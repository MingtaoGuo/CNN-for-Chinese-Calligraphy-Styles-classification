...
def SE_Block(inputs):
    ...
    #In 2017, the last Imgenet champion, the sigmoid gate function was added to the module, which can enhance useful 
    #information between channels and suppress useless information.
    #After the module was added, the recognition rate of four styles of Ou Yan Liu Zhao was increased from 97.2% to 
    #98.125%.
    c = int(inputs.shape[-1])
    ...
    def networks(self, inputs, training):
        with tf.variable_scope("SEnet"):
            ...
            with tf.variable_scope("fullycon"):
                #Removing the full connection layer with global pool replacement has little effect on the final 
                #recognition rate.
